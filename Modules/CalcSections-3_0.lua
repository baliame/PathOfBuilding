...
{ 3, "HitDamage", 1, "Skill Hit Damage", colorCodes.OFFENCE, {
	...
	{ label = "MH Eff. DPS Mod", bgCol = colorCodes.MAINHANDBG, flagList = {"weapon1Attack","effective"},
		...
		{ format = "x {3:output:MainHand.PhysicalEffMult}",
			...
			{ label = "Player modifiers", modName = { "ImpaleDamageMultiplier", modType = "MORE" }, cfg = "weapon1" },
	...
	{ label = "OH Eff. DPS Mod", bgCol = colorCodes.OFFHANDBG, flagList = {"weapon2Attack","effective"},
		...
		{ format = "x {3:output:OffHand.PhysicalEffMult}",
			...
			{ label = "Player modifiers", modName = { "ImpaleDamageMultiplier" }, cfg = "weapon2" },
...
{ 1, "Impale", 1, "Impale", colorCodes.OFFENCE, {
	...
	flag = "impale",
	{ label = "Chance to Impale", { format = "{0:output:ImpaleChance}%",
		{ breakdown = "MainHand.ImpaleChance" },
		{ breakdown = "OffHand.ImpaleChance" },
		{ breakdown = "ImpaleChance" },
		{ label = "Main Hand", flag = "weapon1Attack", modName = "ImpaleChance", modType = "BASE", cfg = "weapon1" },
		{ label = "Off Hand", flag = "weapon2Attack", modName = "ImpaleChance", modType = "BASE", cfg = "weapon2" },
	}, },
	{ label = "Increased Effect", { format = "{0:output:ImpaleEffect}%",
		{ breakdown = "ImpaleEffect" },
		{ label = "Player modifiers", modName = "ImpaleEffect", modType = "INC", cfg = "impale" },
	}, },
	{ label = "Impale hits", { format = "{0:output:ImpaleHits}",
		{ breakdown = "ImpaleHits" },
		{ label = "Player modifiers", modName = "ImpaleHits", modType = "BASE", cfg = "impale" },
	}, },
	{ label = "Phys damage mult", { format = "x {2:output:ImpaleDamageMultiplier}",
		{ breakdown = "MainHand.ImpaleDamageMultiplier" },
		{ breakdown = "OffHand.ImpaleDamageMultiplier" },
