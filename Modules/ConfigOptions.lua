...
return {
	...
	{ var = "multiplierImpaleOnEnemy", type = "count", label = "# of Impale on Enemy:", apply = function(val, modList, enemyModList)
		enemyModList:NewMod("Multiplier:ImpaleOnEnemy", "BASE", val, "Config", { type = "Condition", var = "Effective" })
	end },
